 ...
 */
WorkerGroupManager.prototype.create = function(worker_scpoe_purpose_name, worker_peers_worker_ids_list, callback) {
  // The event is registered by protocols module.
  this._event_listeners['worker-group-create-request'](worker_scpoe_purpose_name, worker_peers_worker_ids_list, callback);
}
