 ...
 */
WorkerScopeManager.prototype.create = function(worker_socket_purpose_name, worker_socket_purpose_parameter, remote_worker_peer_worker_id, callback) {
...
/**
 * @callback module:WorkerScopeManager~callback_of_on_worker_socket_create
 * @param {noxerve_supported_data_type} worker_socket_purpose_parameter - The purpose for this worker socket. Along with it's parameter.
 * @param {integer} remote_worker_id - The worker that you want to communicate with.
 * @param {object} worker_socket
 */
 ...
 */
WorkerScopeManager.prototype.onCreate = function(worker_socket_purpose_name, listener) {
