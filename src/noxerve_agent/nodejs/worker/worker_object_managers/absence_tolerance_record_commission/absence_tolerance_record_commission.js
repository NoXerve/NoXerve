...
function AbsenceToleranceRecordCommission(settings) {
   ...
   */
    ...
    * @private
    */
    this._min_successful_update_commission_peers_count_int = Math.min(this._commission_commission_peers_count, Math.ceil(this._commission_commission_peers_count*(this._min_successful_update_rate_percentage_int/100)) + 1);
    ...
    * @private
    */
    this._update_commission_peers_count_int = Math.min(this._commission_peers_count, Math.ceil(this._commission_peers_count*(this._update_rate_percentage_int/100)));

    this._update_commission_peers_count_int = Math.max(this._update_commission_peers_count_int, this._min_successful_update_commission_peers_count_int);
...
AbsenceToleranceRecordCommission.prototype.updateRecordValue = function(record_name, value, callback) {
  ...
  this._worker_scope.request(this._record_dict[record_name].on_duty_commission_peer_id, data_bytes, (error) => {
    console.log(error);
    // callback();
  });
}
